...
<html>
<head>
<title>Los Angeles Clippers Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: DeAndre Jordan</p>
				<p>Power Forward: Montrezl Harrell</p>
				<p>Small Forward: Danilo Galinari</p>
				<p>Shooting Guard: C.J. Williams</p>
				<p>Point Guard: Austin Rivers</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/clippers.png" alt="clippers" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Clippers Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.losangelesclippers.com"><button class="btn btn-warning">Visit Los Angeles Clippers Website</button></a></h4>
	</div>
</div>
