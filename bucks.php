...
<html>
<head>
<title>Milwaukee Bucks Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		...
		<div class="col-md-4">
			<img src="images/milwaukee_logo.png" alt="milwaukee_logo" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Bucks Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.milwaukeebucks.com"><button class="btn btn-success">Visit Milwaukee Bucks Website</button></a></h4>
	</div>
</div>
