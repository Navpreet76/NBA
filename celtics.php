...
<html>
<head>
<title>Boston Celtics Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		...
		<div class="col-md-4">
			<img src="images/celtics.png" alt="kings" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.bostonceltics.com"><button class="btn btn-success">Visit Boston Celtics Website</button></a></h4>
	</div>
