...
<html>
<head>
<title>Houston Rockets Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Zhou Qi</p>
				<p>Power Forward: Nene</p>
				<p>Small Forward: Gerald Green</p>
				<p>Shooting Guard: James Harden</p>
				<p>Point Guard: Chris Paul</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/houston_rockets.png" alt="rockets" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Rockets Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.houstonrockets.com"><button class="btn btn-danger">Visit Houston Rockets Website</button></a></h4>
	</div>
</div>
