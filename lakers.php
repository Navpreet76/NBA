...
<html>
<head>
<title>Los Angeles Lakers Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Brook Lopez</p>
				<p>Power Forward: Julius Randle</p>
				<p>Small Forward: Brandon Ingram</p>
				<p>Shooting Guard: Kentavious Caldwell-Pope</p>
				<p>Point Guard: Lonzo Ball</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/lakers.png" alt="lakers" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Lakers Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.losangeleslakers.com"><button class="btn btn-warning">Visit Los Angeles Lakers Website</button></a></h4>
	</div>
</div>
