...
<html>
<head>
<title>Orlando Magic Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Marreese Speights</p>
				<p>Power Forward: Bismack Biyombo</p>
				<p>Small Forward: Evan Fournier</p>
				<p>Shooting Guard: Willie Green</p>
				<p>Point Guard: Elfrid Payton</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/orlando_magic.png" alt="magic" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.orlandomagic.com"><button class="btn btn-primary">Visit Orlando Magic Website</button></a></h4>
	</div>
</div>
