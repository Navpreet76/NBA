...
<html>
<head>
<title>Indiana Pacers Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Al Jefferson</p>
				<p>Power Forward: Myles Turner</p>
				<p>Small Forward: Lance Stephenson</p>
				<p>Shooting Guard: Glen Robinson III</p>
				<p>Point Guard: Victor Oladipo</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/pacers_logo.png" alt="pacers_logo" height="400" width="80%">
		</div>
		<div class="col-md-4">
			<div id="flip2"><h4>Toggle/Reserves</h4></div>
			<div id="panel2">
				<p>Center: Marshall Plumlee</p>
				<p>Power Forward: Jabari Parker</p>
				<p>Small Forward: Gianis Antetokounmpo</p>
				<p>Shooting Guard: Malcolm Brogdon</p>
				<p>Point Guard: Matthew Dellavedova</p>
			</div>
		</div>
		<div class="col-md-12">
			<hr>	
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Pacers Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.indianapacers.com"><button class="btn btn-warning">Visit Indiana Pacers Website</button></a></h4>
	</div>
</div>
