...
<html>
<head>
<title>Charlotte Hornets Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Dwight Howard</p>
				<p>Power Forward: Cody Zeller</p>
				<p>Small Forward: Nicolas Batum</p>
				<p>Shooting Guard: Jeremy Lamb</p>
				<p>Point Guard: Kemba Walker</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/charlotte_hornets.png" alt="hornets" height="400" width="80%">
		</div>
		<div class="col-md-4">
			<div id="flip2"><h4>Toggle/Reserves</h4></div>
			<div id="panel2">
				<p>Center: Joel Embiid</p>
				<p>Power Forward: Dario Saric</p>
				<p>Small Forward: Ben Simmons</p>
				<p>Shooting Guard: JJ Redick</p>
				<p>Point Guard: Markelle Fultz</p>
			</div>
		</div>
		<div class="col-md-12">
			<hr>	
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Hornets Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.charlottehornets.com"><button class="btn btn-primary">Visit Charlotte Hornets Website</button></a></h4>
	</div>
</div>
