...
<html>
<head>
<title>San Antonio Spurs Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Nicola Milutinov</p>
				<p>Power Forward: Lamarcus Aldridge</p>
				<p>Small Forward: Kawhi Leonard</p>
				<p>Shooting Guard: Manu Gonobili</p>
				<p>Point Guard: Tony Parker</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/spurs.png" alt="spurs" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Spurs Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.sanantoniospurs.com"><button class="btn btn-warning">Visit San Antonio Spurs Website</button></a></h4>
	</div>
</div>
