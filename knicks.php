...
<html>
<head>
<title>New York Knicks Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Enis Kanter</p>
				<p>Power Forward: Kritaps Porzingis</p>
				<p>Small Forward: Michael beasley</p>
				<p>Shooting Guard: Tim Hardaway Jr.</p>
				<p>Point Guard: Frank Ntilikina</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/knicks_logo.jpg" alt="knicks" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Knicks Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.newyorkknicks.com"><button class="btn btn-primary">Visit New York Knicks Website</button></a></h4>
	</div>
</div>
