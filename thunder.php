...
<html>
<head>
<title>Oklahoma City Thunder Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Steven Adams</p>
				<p>Power Forward: Paul George</p>
				<p>Small Forward: Carmelo Anthony</p>
				<p>Shooting Guard: Terrance Ferguson</p>
				<p>Point Guard: Russell Westbrook</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/thunder_logo.png" alt="thunder" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Thunder Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.nba.com/thunder"><button class="btn btn-info">Visit Oklahoma City Website</button></a></h4>
	</div>
</div>
