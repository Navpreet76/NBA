...
<html>
<head>
<title>Philadelphia 76ers Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		...
		<div class="col-md-4">
			<img src="images/philadelphia_logo.png" alt="sixers" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">76ers Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.philadelphia76ers.com"><button class="btn btn-primary">Visit Philadelphia 76ers Website</button></a></h4>
	</div>
</div>
