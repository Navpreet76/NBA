...
<html>
<head>
<title>Chicago Bulls Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Robin Lopez</p>
				<p>Power Forward: Lauri Markenen</p>
				<p>Small Forward: Nicola Mirotic</p>
				<p>Shooting Guard: Zach Levine</p>
				<p>Point Guard: Kris Dunn</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/bulls.jpg" alt="bulls" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Cleveland Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.chicagobulls.com"><button class="btn btn-danger">Visit Chicago Bulls Website</button></a></h4>
	</div>
</div>
