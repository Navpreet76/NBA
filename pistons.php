...
<html>
<head>
<title>Detroit Pistons Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Andre Drummond</p>
				<p>Power Forward: John Leuer</p>
				<p>Small Forward: Blake Griffin</p>
				<p>Shooting Guard: Luke Kennard</p>
				<p>Point Guard: Reggie Jackson</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/detroit_pistons_logo.png" alt="pistons" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Pistons Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.detroitpistons.com"><button class="btn btn-primary">Visit Detroit Pistons Website</button></a></h4>
	</div>
</div>
