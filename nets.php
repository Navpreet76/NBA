...
<html>
<head>
<title>Brooklyn Nets page Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Jahlil Okafor</p>
				<p>Power Forward: Rondae Hollis Jefferson</p>
				<p>Small Forward: Demarre Carroll</p>
				<p>Shooting Guard: Deangelo Russell</p>
				<p>Point Guard: Jeremy Lin</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/brooklyn_nets.png" alt="nets" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Nets Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.Brooklynnets.com"><button class="btn btn-primary">Visit Brooklyn Nets Website</button></a></h4>
	</div>
</div>
