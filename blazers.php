...
<html>
<head>
<title>Portland Trainblazers Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Jusuf Nurkic</p>
				<p>Power Forward: Meyers Leonard</p>
				<p>Small Forward: Al-Farouq Aminu</p>
				<p>Shooting Guard: C. J. McCollum</p>
				<p>Point Guard: Damian Lillard</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/trail_blazers.gif" alt="blazers" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Trail Blazers Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.portlandtrailblazers.com"><button class="btn btn-info">Visit Portland Trail Blazers Website</button></a></h4>
	</div>
</div>
