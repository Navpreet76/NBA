...
<html>
<head>
<title>Atlanta Hawks Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Dewayne Dedmon</p>
				<p>Power Forward: John Collins</p>
				<p>Small Forward: Kent Bazemore</p>
				<p>Shooting Guard: Tyler Dorsey</p>
				<p>Point Guard: Dennis Shroder</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/Atlanta-Hawks-Logo.gif" alt="hawks" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Hawks Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.atlantahawks.com"><button class="btn btn-primary">Visit Atlanta Hawks Website</button></a></h4>
	</div>
</div>
