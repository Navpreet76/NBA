...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Tyson Chandler</p>
				<p>Power Forward: Marquese Chriss</p>
				<p>Small Forward: Josh Jackson</p>
				<p>Shooting Guard: Devin Booker</p>
				<p>Point Guard: Tyler Ulis</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/suns.png" alt="suns" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Suns Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.phoenixsuns.com"><button class="btn btn-warning">Visit Phoenix Suns Website</button></a></h4>
	</div>
</div>
