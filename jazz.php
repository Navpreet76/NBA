...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Rudy Gobert</p>
				<p>Power Forward: Derrick Favors</p>
				<p>Small Forward: Joe Johnson</p>
				<p>Shooting Guard: Donovan Mitchell</p>
				<p>Point Guard: Ricky Rubio</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/jazz_logo.png" alt="jazz" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.utahjazz.com"><button class="btn btn-success">Visit Utah Jazz Website</button></a></h4>
	</div>
</div>
