...
<html>
<head>
<title>Memphis Grizzlies Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Marc Gasol</p>
				<p>Power Forward: Tyreke Evans</p>
				<p>Small Forward: Chandler Parsons</p>
				<p>Shooting Guard: Mario Chalmers</p>
				<p>Point Guard: Mike Conley Jr.</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/Memphis-Grizzlies-Logo.jpg" alt="Grizzlies" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Grizzlies Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.memphisgrizzlies.com"><button class="btn btn-success">Visit Memphis Grizzlies Website</button></a></h4>
	</div>
</div>
