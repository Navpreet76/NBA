...
<html>
<head>
<title>Cleveland Cavaliers Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Kevin Love</p>
				<p>Power Forward: Tristan Thompson</p>
				<p>Small Forward: Lebron James</p>
				<p>Shooting Guard: JR Smith</p>
				<p>Point Guard: Isaiah Thomas</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/cavaliers_logo.jpg" alt="raptos" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.clevelandcavaliers.com"><button class="btn btn-danger">Visit Cleveland Cavaliers Website</button></a></h4>
	</div>
</div>
