...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Hassan Whiteside</p>
				<p>Power Forward: Kelly Olynyk</p>
				<p>Small Forward: James Johnson</p>
				<p>Shooting Guard: Dion Waiters</p>
				<p>Point Guard: Goran Dragic</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/miami_heat.png" alt="heat" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.miamiheat.com"><button class="btn btn-danger">Visit Miami Heat Website</button></a></h4>
	</div>
</div>
