...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Marcin Gortat</p>
				<p>Power Forward: Markieff Morris</p>
				<p>Small Forward: Otto Porter Jr</p>
				<p>Shooting Guard: Bradley Beal</p>
				<p>Point Guard: John Wall</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/wizards_logo.png" alt="wizards_logo" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Heat Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.washingtonwizards.com"><button class="btn btn-danger">Visit Washington Wizards Website</button></a></h4>
	</div>
</div>
