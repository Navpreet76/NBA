...
<html>
<head>
<title>Golden State Warriors Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Draymond Green</p>
				<p>Power Forward: Andre Iguodala</p>
				<p>Small Forward: Kevin Durant</p>
				<p>Shooting Guard: Klay Thompson</p>
				<p>Point Guard: Stephen Curry</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/warriors.png" alt="warriors" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Warriors Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.goldenstatewarriors.com"><button class="btn btn-warning">Visit Golden State Warriors Website</button></a></h4>
	</div>
</div>
