...
<html>
<head>
<title>Sacramento Kings Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Willie Cauley Stein</p>
				<p>Power Forward: Zach Randolph</p>
				<p>Small Forward: Vince Carter</p>
				<p>Shooting Guard: Buddy Heild</p>
				<p>Point Guard: Dearron Fox</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/kings.png" alt="kings" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Jazz Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.sacramentokings.com"><button class="btn btn-success">Visit Sacramento Kings Website</button></a></h4>
	</div>
</div>
