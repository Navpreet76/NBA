...
<html>
<head>
<title>Dallas Mavericks Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Salah Mejri</p>
				<p>Power Forward: Dirk Nowitski</p>
				<p>Small Forward: Harrison Barnes</p>
				<p>Shooting Guard: Dennis Smith Jr.</p>
				<p>Point Guard: Seth Curry</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/mavericks.jpg" alt="mavericks" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Mavericks Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.dallasmavericks.com"><button class="btn btn-primary">Visit Dallas Mavericks Website</button></a></h4>
	</div>
</div>
