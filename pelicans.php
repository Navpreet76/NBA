...
<html>
<head>
<title>New Orleans Pelicans Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Anthony Davis</p>
				<p>Power Forward: Demarcus Cousins</p>
				<p>Small Forward: Solomon Hill</p>
				<p>Shooting Guard: Jrue Holiday</p>
				<p>Point Guard: Rajon Rondo</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/pelicans_logo.png" alt="pelicans" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">Pelicans Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.neworleanspelicans.com"><button class="btn btn-info">Visit New Orleans Pelicans Website</button></a></h4>
	</div>
</div>
