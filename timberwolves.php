...
<html>
<head>
<title>Minnesota Timberwolves Page</title>
<script>
...
<div id="wrapper">
	<div class="col-md-12">
		<div class="col-md-4">
			...
			<div id="panel">
				<p>Center: Karl Anthony Towns</p>
				<p>Power Forward: Andrew Wiggins</p>
				<p>Small Forward: Jimmy Butler</p>
				<p>Shooting Guard: Tyus Jones</p>
				<p>Point Guard: Jeff Teague</p>
			</div>
		</div>
		<div class="col-md-4">
			<img src="images/Minnesota_Timberwolves.png" alt="timberwolves" height="400" width="80%">
		</div>
		<div class="col-md-4">
	...
	<div class="col-md-12">
		...
		<h1 class="text-danger">TImberwolves Starters</h1>
		<div class="col-md-2">
			<div class="thumbnail">
	...
	<div class="col-md-12">
	<hr>
		<h4 class="text-center"><a href="http://www.minnesotatimberwolves.com"><button class="btn btn-warning">Visit Minnesota Timberwolves Website</button></a></h4>
	</div>
</div>
